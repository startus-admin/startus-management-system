...
const DEFAULT_ORIGIN = 'https://startus-shop-six.vercel.app';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${allowedOrigin}/#/confirmation/${orderNumber}?payment=success`,
      cancel_url: `${allowedOrigin}/#/confirmation/${orderNumber}?payment=cancelled`,
    });
